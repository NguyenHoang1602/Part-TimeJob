...
const DetailsScreen = ({route, navigation}) => {
  ...
  console.log('user log: ', user.messagingToken);
  const datalist = {
  ...
  const toggleModal = () => {
    // if else (check thong tin cua nguoi dung, thong tin null, thong bao cap nhat thong tin, bay qua trang cap nhat thong tin)
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headers}>
        ...
        {isSave(data.postid) ? (
          <TouchableOpacity onPress={() => handleDelete(data.postid)}>
            <Icons
          ...
          <TouchableOpacity onPress={() => handleSaveToggle(data.postid)}>
            <Icons
              style={{marginRight: 22}}
              name="bookmark-add"
              size={28}
        ...
        <View style={{width: '100%', paddingHorizontal: 15}}>
          <View style={styles.postHeaders}>
            ...
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                {data?.wage_min}đ - {data?.wage_max}đ
              </Text>
            ...
            <Text style={styles.datetime}>
              Đã đăng {data?.date} ngày trước vào lúc {data?.time}
            </Text>
          ...
          <View style={styles.item1}>
            ...
            <Text style={styles.itemText}>
              Hình thức trả lương: {data?.payform_id?.title}
            </Text>
          </View>
          <View style={styles.item}>
            <Octicons name="log" size={24} color={COLORS.blue} />
            <Text style={styles.itemText}>
              Loại công việc: {data?.worktype_id}
            </Text>
          </View>
          <View style={styles.item}>
          ...
          <View style={styles.item}>
            ...
            <Text style={styles.itemText}>
              Kinh nghiệm: {data?.experience_id}
            </Text>
          </View>
          <View style={styles.item}>
            <Octicons name="mortar-board" size={24} color={COLORS.blue} />
            <Text style={styles.itemText}>
              Trình độ học vấn: {data?.acedemic_id}
            </Text>
          </View>
          <View style={styles.item}>
          ...
          <View style={styles.item}>
            ...
            <Text style={styles.itemText}>
              Tên Công ty: {data?.business_name}
            </Text>
          </View>
          <View style={styles.item}>
            <Octicons name="people" size={24} color={COLORS.blue} />
            <Text style={styles.itemText}>
              Số lượng tuyển dụng: {data?.quantity}
            </Text>
          </View>
          <View style={styles.item}>
          ...
          <View
            style={{width: '100%', alignItems: 'center', paddingVertical: 50}}>
              ...
              ListEmptyComponent={() => (
                <View
                  ...
                  <Text
                    ...
                    Không có CV liên quan đến công việc này
                  </Text>
                </View>
              )}
            />
