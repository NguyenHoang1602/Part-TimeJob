...
const ApplicationsStageScreen = ({ route, navigation }) => {
  const datalist = {
    ...
    bussiness_Name: route.params?.bussiness_Name,
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white, paddingTop: 25 }}>
      ...
      <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', flex: 1 }}>
        <View style={{ padding: 20, width: '90%', height: '49%', borderWidth: 0.5, borderColor: COLORS.grey, borderRadius: 20, alignItems: 'center' }}>
          <ImageBackground
            source={{ uri: data.image }}
            style={{ width: 90, height: 90, marginBottom: 15 }}
            imageStyle={{ borderRadius: 10, borderWidth: 0.5, borderColor: COLORS.grey }}
          />
          <Text style={{ fontSize: 22, fontWeight: '600', color: '#212121' }}>{data.title}</Text>
          <Text style={{ fontSize: 17, fontWeight: '500', color: '#246BFD', marginVertical: 5 }}>{data.bussiness_Name}</Text>
          <View style={{ height: 1, width: '99%', backgroundColor: COLORS.grey, opacity: 0.4, marginTop: 15, marginBottom: 8 }} />
          <Text style={{ fontSize: 17, fontWeight: '500', color: '#959595', marginTop: 5, marginVertical: 5 }}>{data.address}</Text>
          <Text style={{ fontSize: 17, fontWeight: '400', color: '#246BFD', marginTop: 5, marginVertical: 5 }}>${data.wageMin} - ${data.wageMax} /month</Text>
          <View style={{
            width: 60,
            height: 25,
            borderWidth: 0.5,
        ...
        <Text style={{ fontSize: 17, fontWeight: '500', color: '#414141' }}>Trạng thái ứng tuyển</Text>
        {
          data.status === '1' ? (
            ...
            <View style={{ marginTop: '8%', width: '90%', height: 50, borderRadius: 10, backgroundColor: '#E7FEEE', alignItems: 'center', justifyContent: 'center', marginBottom: '20%' }}>
              <Text style={{ fontSize: 17, fontWeight: '500', color: '#08BE75' }}>Application Sent</Text>
            </View>
          ) : data.status === '3' ? (
            <View style={{ marginTop: '8%', width: '90%', height: 50, borderRadius: 10, backgroundColor: '#FDD9DA', alignItems: 'center', justifyContent: 'center', marginBottom: '20%' }}>
              <Text style={{ fontSize: 17, fontWeight: '500', color: '#F75656' }}>Application Sent</Text>
            </View>
          ) :
            <View style={{ marginTop: '8%', width: '90%', height: 50, borderRadius: 10, backgroundColor: '#FFF4CD', alignItems: 'center', justifyContent: 'center', marginBottom: '20%' }}>
              <Text style={{ fontSize: 17, fontWeight: '500', color: '#FBCA17' }}>Application Sent</Text>
            </View>
        }
      </View>
