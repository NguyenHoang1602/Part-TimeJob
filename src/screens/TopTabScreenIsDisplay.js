            ...
            >
                <View style={{ width: '100%', flexDirection: 'row' }}>
                    ...
                    <View style={{ width: '50%', height: '100%', marginStart: 20, flex: 1 }}>
                        <Text style={{ fontSize: 18, fontFamily: 'BeVietnamPro-Medium', marginTop: -4, }}>{item.title}</Text>
                ...
                <View style={{ width: '100%', paddingStart: '22%' }}>
                    <Text numberOfLines={1} style={{ fontSize: 16, fontFamily: 'BeVietnamPro-Medium', marginTop: -4, color: COLORS.grey, width: 200, marginBottom: 5 }}>{item.businessName}</Text>
                    ...
                    <View style={{
                    ...
                    }}>
                        {
                            item.workType_id === "653e66b38e88b23b41388e3c" ? (
                                <Text style={{ fontSize: 10, fontFamily: 'BeVietnamPro-Medium', marginTop: -4, }} >Bán thời gian</Text>
                            ) : item.workType_id === "6558634415be344ac80a3b40" ? (
                                    <Text style={{ fontSize: 10, fontFamily: 'BeVietnamPro-Medium', marginTop: -4, }} >Toàn thời gian</Text>
                            ) : null
                        }
                    </View>
                </View>
