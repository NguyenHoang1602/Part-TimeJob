    ...
    const renderCareers = ({ item }) => (
        <Pressable
            ...
            <View style={{ marginLeft: 15, flex: 1 }}>
                <Text numberOfLines={1} style={{ fontSize: 16,fontFamily: 'BeVietnamPro-Medium',marginTop:-2, color: COLORS.black }}>{item.title}</Text>
            </View>
        </Pressable>
    );
    ...
    return (
        <SafeAreaView style={styles.container}>
            <TouchableOpacity
                ...
                <Text style={{ fontSize: 22, fontFamily: 'BeVietnamPro-Bold',marginTop:-2, color: COLORS.black, marginLeft: 20 }}>Quản lí CV</Text>
            </TouchableOpacity>
            <View style={{ flexDirection: 'column', backgroundColor: '#EEEEEE', width: '100%', height: 140, borderRadius: 10, borderWidth: 1, borderColor: '#DDDDDD', marginTop: 20 }}>
                <TouchableOpacity onPress={() => navigation.navigate('Tạo CV cá nhân')}>
                    ...
                    <Text style={{ fontSize: 14, fontFamily: 'BeVietnamPro-Medium',marginTop:-2, color: '#808080', textAlign: 'center', marginTop: 10 }}>Thêm mới CV</Text>
                </TouchableOpacity>
            </View>
                    ...
                    <><FlatList
                        ...
                        ListEmptyComponent={() => (
                            <View style={{ alignItems: 'center', justifyContent: 'center', paddingHorizontal: 20 }}>
                                ...
                                />
                                <Text style={{ fontSize: 22, color: COLORS.black, fontFamily: 'BeVietnamPro-Medium',marginTop:-2 }}>Không có CV</Text>
                            </View>
                        )}
                    />
                    </>
